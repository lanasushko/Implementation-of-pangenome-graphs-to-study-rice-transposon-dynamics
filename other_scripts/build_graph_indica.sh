...
mkdir constructed_indica

INPUT=$(cat variantfiles_indica.txt)
...
bcftools merge -m none --force-samples -o constructed_indica/merged.vcf $INPUT

cd constructed_indica/
